# ==========================================================
# PHASE 1 — Standalone Live Validation (TFLite + YOLO)
# ==========================================================
...
def main():
    print("Initializing Phase 1 Live Validator...")
    try:
    ...
    if args.session_id:
        try:
            ...
            # Phase 1 runs on 8001
            api_url = f"http://localhost:8001/session-points/{args.session_id}?side={args.side}"
    ...
    print("\n--- Phase 1 Live Validation Started ---")
    print("Press 'q' to quit")
    print("Press '1'-'5' to set number of target points")
    ...
    while True:
        ...
        if last_has_ear:
            ...
            if last_annotated is not None:
                cv2.imshow("Normalized Ear (Phase 1)", last_annotated)
        ...
        cv2.imshow("Phase 1 Live View", display_frame)
