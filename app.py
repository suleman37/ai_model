...
MODEL_PATH = os.path.join(BASE_DIR, "best_float16.tflite")
MODEL_TASK = "segment"
IMAGE_SIZE = 256
PIXELS_PER_CM = 100
...
def load_model_on_startup():
    ...
    try:
        ...
        logger.info(f"✓ YOLO model loaded from {MODEL_PATH} with task={MODEL_TASK}")
        # detect_model = YOLO(r"C:\Users\hp\Desktop\FASTAPI\Ear\models\best_float16.tflite", task='detect')
